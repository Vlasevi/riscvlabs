...
set rc [catch {
  ...
  add_files -quiet /home/vladimir/RVfpgaSoC/Labs/LabProjects/Lab1/Lab1.runs/synth_1/rvfpga.dcp
...
set rc [catch {
  ...
  set src_rc [catch { 
    puts "source /home/vladimir/RVfpgaSoC/Labs/LabResources/Lab1/script.tcl"
    source /home/vladimir/RVfpgaSoC/Labs/LabResources/Lab1/script.tcl
  } _RESULT] 
  if {$src_rc} { 
    send_msg_id runtcl-1 error "$_RESULT"
    send_msg_id runtcl-2 error "sourcing script /home/vladimir/RVfpgaSoC/Labs/LabResources/Lab1/script.tcl failed"
    return -code error
  }
